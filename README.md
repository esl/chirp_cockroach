...
Persistent Volume Claims were assigned to pods with CockroachDB and the cluster was already
...
Chris McCord - for creating real-time Twitter [clone](https://www.youtube.com/watch?v=MZvmYaFkNJI) which was used as a base
