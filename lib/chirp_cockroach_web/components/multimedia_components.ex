defmodule ChirpCockroachWeb.MultimediaComponents do
  ...
  attr :transcription, :string, default: nil
    ...
    ~H"""
      <div>
        <%= if @join_event do %>
          ...
          <.microphone_button id="stream-microphone" upload_id={@transcription} control_stream={"enabled"}>Enable Microphone</.microphone_button>
        <% end %>
