defmodule ChirpCockroachWeb.UserAuth do
  use ChirpCockroachWeb, :verified_routes
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      ChirpCockroachWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  defp signed_in_path(_conn), do: ~p"/posts"
end
