defmodule ChirpCockroachWeb do
  @moduledoc """
  ...
  def static_paths, do: ~w(assets fonts images tmp favicon.ico robots.txt)
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/chirp_cockroach_web/templates",
        namespace: ChirpCockroachWeb
